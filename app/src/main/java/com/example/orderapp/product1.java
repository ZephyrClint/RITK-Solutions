...
public class product1 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setProduct details
        productName.setText("Hotpot");
        imageView.setImageResource(R.drawable.hotpot);
        productDesc.setText(getString(R.string.Hotpot));

        //save to cart
        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(product1.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int basePrice = 1500;
                if (quantity == 0) {
                    Toast.makeText(product1.this, "Cannot select lower than 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int pPrice = basePrice * quantity;
