...
public class product4 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Shrimp with Vermicelli and Garlic");
        imageView.setImageResource(R.drawable.shrimp1);
        productDesc.setText(getString(R.string.Shrimp));

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(product4.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 1500;
                if (quantity == 0) {
                    Toast.makeText(product4.this, "Cannot select lower than 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int pPrice = basePrice * quantity;
