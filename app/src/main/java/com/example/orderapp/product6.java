...
public class product6 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Chow Mein");
        imageView.setImageResource(R.drawable.chow);
        productDesc.setText(getString(R.string.ChowMein));

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(product6.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 1500;
                if (quantity == 0) {
                    Toast.makeText(product6.this, "Cannot select lower than 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int pPrice = basePrice * quantity;
