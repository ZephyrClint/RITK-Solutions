...
public class product9 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName.setText("Fried Shrimp with Cashew Nuts");
        imageView.setImageResource(R.drawable.shrimp2);
        productDesc.setText(getString(R.string.FriedShrimp));

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(product9.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int basePrice = 1500;
                if (quantity == 0) {
                    Toast.makeText(product9.this, "Cannot select lower than 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int pPrice = basePrice * quantity;
